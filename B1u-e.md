...
- 去中心化无需依赖第三方、抗单点故障与抗审查、透明性、公平性、不可篡改、数据安全、可追溯。
...
- 可扩展性较差、用户体验与成本、法律与法规风险、安全与治理问题

**可扩展性瓶颈**：公链在节点众多时共识效率低下，吞吐量和延迟问题突出，目前各大项目正通过分片、Layer 2 方案等技术进行优化。

**安全与治理难题**：区块链的不可篡改特性虽能保证数据安全，但代码漏洞或治理失衡（如 DAO 中投票权集中）也可能导致严重损失。
